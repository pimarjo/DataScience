...
best_rf_model_freq[,4] <- c(mean(predict(rf_freq_final_expo_as_weights)) - mean(test$ClaimNb), mean(predict(rf_freq_final_expo_as_exp)) - mean(test$ClaimNb))
